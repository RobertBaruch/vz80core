...
`include "z80fi_insn_spec_bit_ind_hl.sv"
`include "z80fi_insn_spec_ld_idx_ixiy_reg.sv"
`include "z80fi_insn_spec_add_ixiy_ss.sv"
`include "z80fi_insn_spec_ld_a_r.sv"
`include "z80fi_insn_spec_ret_cond.sv"
`include "z80fi_insn_spec_jp_cond.sv"
`include "z80fi_insn_spec_jp.sv"
...
`include "z80fi_insn_spec_shift_idx_ixiy.sv"
`include "z80fi_insn_spec_in_a.sv"
`include "z80fi_insn_spec_ld_ind_bcde_a.sv"
`include "z80fi_insn_spec_ld_reg_n.sv"
`include "z80fi_insn_spec_bit_reg.sv"
`include "z80fi_insn_spec_inc_dec_dd.sv"
`include "z80fi_insn_spec_ld_hl_ind_nn.sv"
`include "z80fi_insn_spec_reti.sv"
`include "z80fi_insn_spec_in_reg.sv"
`include "z80fi_insn_spec_exx.sv"
`include "z80fi_insn_spec_out_a.sv"
`include "z80fi_insn_spec_rst.sv"
`include "z80fi_insn_spec_adc_sbc_hl_dd.sv"
`include "z80fi_insn_spec_out_block.sv"
...
`include "z80fi_insn_spec_shift_ind_hl.sv"
`include "z80fi_insn_spec_ld_ind_nn_hl.sv"
`include "z80fi_insn_spec_jp_ind_hl.sv"
`include "z80fi_insn_spec_neg.sv"
`include "z80fi_insn_spec_pop_ixiy.sv"
`include "z80fi_insn_spec_jp_ind_ixiy.sv"
...
z80fi_insn_spec_djnz insn_spec_djnz(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
...
z80fi_insn_spec_retn insn_spec_retn(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[1])
...
z80fi_insn_spec_rot_dec insn_spec_rot_dec(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[5])
...
z80fi_insn_spec_set_res_ind_hl insn_spec_set_res_ind_hl(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[7])
...
z80fi_insn_spec_set_res_reg insn_spec_set_res_reg(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[10])
...
z80fi_insn_spec_bit_idx_ixiy insn_spec_bit_idx_ixiy(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[14])
...
z80fi_insn_spec_ld_reg_ind_hl insn_spec_ld_reg_ind_hl(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[15])
...
z80fi_insn_spec_im insn_spec_im(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[16])
...
z80fi_insn_spec_jr insn_spec_jr(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[17])
...
z80fi_insn_spec_in_block insn_spec_in_block(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[25])
...
z80fi_insn_spec_jr_cond insn_spec_jr_cond(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[28])
...
z80fi_insn_spec_call insn_spec_call(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[31])
...
z80fi_insn_spec_ret insn_spec_ret(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[36])
...
z80fi_insn_spec_set_res_idx_ixiy insn_spec_set_res_idx_ixiy(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[38])
...
z80fi_insn_spec_call_cond insn_spec_call_cond(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[42])
...
z80fi_insn_spec_out_reg insn_spec_out_reg(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[43])
...
z80fi_insn_spec_shift_reg insn_spec_shift_reg(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[47])
...
z80fi_insn_spec_bit_ind_hl insn_spec_bit_ind_hl(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[57])
...
z80fi_insn_spec_ret_cond insn_spec_ret_cond(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[61])
...
z80fi_insn_spec_jp_cond insn_spec_jp_cond(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[62])
...
z80fi_insn_spec_jp insn_spec_jp(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[63])
...
z80fi_insn_spec_shift_idx_ixiy insn_spec_shift_idx_ixiy(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[68])
...
z80fi_insn_spec_in_a insn_spec_in_a(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[69])
...
z80fi_insn_spec_bit_reg insn_spec_bit_reg(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[72])
...
z80fi_insn_spec_reti insn_spec_reti(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[75])
...
z80fi_insn_spec_in_reg insn_spec_in_reg(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[76])
...
z80fi_insn_spec_out_a insn_spec_out_a(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[78])
...
z80fi_insn_spec_rst insn_spec_rst(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[79])
...
z80fi_insn_spec_out_block insn_spec_out_block(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[81])
...
z80fi_insn_spec_shift_ind_hl insn_spec_shift_ind_hl(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[88])
...
z80fi_insn_spec_jp_ind_hl insn_spec_jp_ind_hl(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[90])
...
z80fi_insn_spec_jp_ind_ixiy insn_spec_jp_ind_ixiy(
    .z80fi_valid(1'b1),
    .z80fi_insn(insn),
    .z80fi_insn_len(insn_len),
    .spec_valid(valid[93])
