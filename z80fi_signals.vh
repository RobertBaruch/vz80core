...
`define SPEC_MEM_RD 28'b0000000000000000000000000001
`define SPEC_MEM_RD2 28'b0000000000000000000000000010
`define SPEC_MEM_WR 28'b0000000000000000000000000100
`define SPEC_MEM_WR2 28'b0000000000000000000000001000
`define SPEC_REG_IP 28'b0000000000000000000000010000
`define SPEC_REG_A 28'b0000000000000000000000100000
`define SPEC_REG_F 28'b0000000000000000000001000000
`define SPEC_REG_B 28'b0000000000000000000010000000
`define SPEC_REG_C 28'b0000000000000000000100000000
`define SPEC_REG_D 28'b0000000000000000001000000000
`define SPEC_REG_E 28'b0000000000000000010000000000
`define SPEC_REG_H 28'b0000000000000000100000000000
`define SPEC_REG_L 28'b0000000000000001000000000000
`define SPEC_REG_A2 28'b0000000000000010000000000000
`define SPEC_REG_F2 28'b0000000000000100000000000000
`define SPEC_REG_B2 28'b0000000000001000000000000000
`define SPEC_REG_C2 28'b0000000000010000000000000000
`define SPEC_REG_D2 28'b0000000000100000000000000000
`define SPEC_REG_E2 28'b0000000001000000000000000000
`define SPEC_REG_H2 28'b0000000010000000000000000000
`define SPEC_REG_L2 28'b0000000100000000000000000000
`define SPEC_REG_IX 28'b0000001000000000000000000000
`define SPEC_REG_IY 28'b0000010000000000000000000000
`define SPEC_REG_SP 28'b0000100000000000000000000000
`define SPEC_REG_I 28'b0001000000000000000000000000
`define SPEC_REG_R 28'b0010000000000000000000000000
`define SPEC_REG_IFF1 28'b0100000000000000000000000000
`define SPEC_REG_IFF2 28'b1000000000000000000000000000

`define Z80FI_SPEC_SIGNALS \
logic [27:0] spec_signals; \
...
assign spec_reg_f = spec_signals[6]; \
assign spec_reg_b = spec_signals[7]; \
assign spec_reg_c = spec_signals[8]; \
assign spec_reg_d = spec_signals[9]; \
assign spec_reg_e = spec_signals[10]; \
assign spec_reg_h = spec_signals[11]; \
assign spec_reg_l = spec_signals[12]; \
assign spec_reg_a2 = spec_signals[13]; \
assign spec_reg_f2 = spec_signals[14]; \
assign spec_reg_b2 = spec_signals[15]; \
assign spec_reg_c2 = spec_signals[16]; \
assign spec_reg_d2 = spec_signals[17]; \
assign spec_reg_e2 = spec_signals[18]; \
assign spec_reg_h2 = spec_signals[19]; \
assign spec_reg_l2 = spec_signals[20]; \
assign spec_reg_ix = spec_signals[21]; \
assign spec_reg_iy = spec_signals[22]; \
assign spec_reg_sp = spec_signals[23]; \
assign spec_reg_i = spec_signals[24]; \
assign spec_reg_r = spec_signals[25]; \
assign spec_reg_iff1 = spec_signals[26]; \
assign spec_reg_iff2 = spec_signals[27]; \
